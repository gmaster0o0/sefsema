...
- [ ] Create admin dashboard for user/recipe management

## Security & Authentication

- [ ] Implement OAuth2 integration (Google, GitHub, Microsoft)
- [ ] Add strict password validation (minimum length 8 chars, require uppercase, lowercase, numbers, special characters)
